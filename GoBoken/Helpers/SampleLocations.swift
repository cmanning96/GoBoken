...
struct SampleLocations {
  ...
  static let allLocations = [
    ...
    Location(name: "Biergarten", address: "1422 Grand Street", image: UIImage(named: "bg")!, keywords: [LocationKeywords.dining], description: "An authentic Austro-Hungarian biergarten with some of the best dining in the region. Set in a turn-of-the-century bier hall with an adjoining, sunny biergarten, it's the perfect place to spend the day with good friends and good cheer."),
  ...
  static func getLocations(withKeyword: LocationKeywords?) -> [Location] {
