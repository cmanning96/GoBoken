...
struct SampleLocations {
    ...
    static let allLocations = [
        ...
        Location(name: "Hoboken Historical Museum",
                 ...
                 description: "The Hoboken Historical Museum (est. 1986) collects and displays artifacts in themed exhibitions on Hoboken history and offers educational programs, lectures, tours and hosts films and plays. We are a registered 501(c)3 nonprofit organization.",
