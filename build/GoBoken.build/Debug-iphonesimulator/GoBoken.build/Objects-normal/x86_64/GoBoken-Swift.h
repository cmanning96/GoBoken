...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GoBoken",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7GoBoken11AppDelegate")
...
SWIFT_CLASS("_TtC7GoBoken21LocationTableViewCell")
...
SWIFT_CLASS("_TtC7GoBoken22LocationViewController")
@interface LocationViewController : UIViewController
- (void)viewDidLoad;
- (void)toggleMapSize;
- (IBAction)dismissViewController:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7GoBoken13MapAnnotation")
...
SWIFT_CLASS("_TtC7GoBoken28RecommendationsTableViewCell")
@interface RecommendationsTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified RecmdImg;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified RecmdLbl;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC7GoBoken29RecommendationsViewController")
@interface RecommendationsViewController : UITableViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC7GoBoken12ToggleButton")
...
SWIFT_CLASS("_TtC7GoBoken18TourViewController")
@interface TourViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tourtable;
- (IBAction)onBackClicked:(id _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
